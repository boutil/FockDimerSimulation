...
public class DataExport {
    public static void main(String[] args) {
        ...
        // double[][] ABs = {{-3, -2}, {-5, -2}, {-0.9, -0.1}};
        double[][] ABs = {{-0.9, -0.1}, {-0.99, -0.01}, {-0.999, -0.001}, {-0.9999, -0.0001}, {-0.99999, -0.00001}, {-0.999999, -0.000001}, {-0.9999999, -0.0000001}};
        ...
        for (int i = 0; i < params.length; i++) {
            ...
            SchottkyDimers dimers = new SchottkyDimers(schottkyData, params[i].angles);
        ...
        try {
            BufferedWriter bw = new BufferedWriter(new FileWriter("exportedPoints_depth_1.json"));
    ...
    public static double[][][] extractAmoebaPointsFromSchottky(SchottkyDimers dimers, Complex[][] points) {
        ...
        for (int i = 0; i < points.length; i++){
            ...
            for (int j = 0; j < points[i].length; j++){
                try {
                    mappedP.add(new Double[]{dimers.amoebaMapHexGrid(points[i][j]).re,dimers.amoebaMapHexGrid(points[i][j]).im});
